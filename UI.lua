	...
	function menu:AddTab(options)
		...
		function tab:AddSection(options)
			...
			function section:AddToggle(options)
				...
				ToggleIcon.ImageRectOffset = Vector2.new(924, 724)
				ToggleIcon.ImageRectSize = Vector2.new(36, 36)
				ToggleIcon.ImageColor3 = Color3.fromRGB(56, 149, 238)
				ToggleIcon.Visible = options.default
